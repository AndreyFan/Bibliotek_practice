...
public class BookServiceImpl implements BookService {
    ...
    public boolean createBook(BookDto newBookDto) {
        Book createBook = new Book(null,
                newBookDto.getTitle(),
                newBookDto.getAuthorName(),
                Genre.valueOf(newBookDto.getGenre().toUpperCase()),
                newBookDto.getYearPublished());
    ...
    public boolean updateBook(BookDto updatedBookDto) {
        Book upBook = new Book(updatedBookDto.getBookId(),
                updatedBookDto.getTitle(),
                updatedBookDto.getAuthorName(),
                Genre.valueOf(updatedBookDto.getGenre().toUpperCase()),
                updatedBookDto.getYearPublished());
