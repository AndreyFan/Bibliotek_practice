...
CREATE TABLE books (
                      ...
                      genre  VARCHAR(32) NOT NULL, -- Genre as ENUM
...
CREATE TABLE readers (
                        ...
                        reader_name VARCHAR(255) NOT NULL,        -- Name of the reader
...
CREATE TABLE loans (
                      ...
                      reader_id INT NOT NULL,                   -- Foreign Key to Reader
                      book_id INT NOT NULL,                     -- Foreign Key to Book
                      loan_date DATE NOT NULL,                  -- Date when book was loaned
